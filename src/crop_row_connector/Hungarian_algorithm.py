...
class HungarianAlgorithm:
    ...
    def min_zero_row(self, zero_mat: np.ndarray, mark_zero: list[tuple[int, Any]]) -> None:
        """
    ...
    def mark_matrix(self, mat: np.ndarray) -> tuple[list[tuple[int, Any]], list[int], list[int]]:
    ...
    def adjust_matrix(self, mat: np.ndarray, cover_rows: list[int], cover_cols: list[int]) -> np.ndarray:
        cur_mat = mat
        non_zero_element = []
    ...
    def hungarian_algorithm(self, mat: np.ndarray) -> np.ndarray:
        dim = mat.shape[0]
        cur_mat = mat
    ...
    def main(self, cost_matrix: np.ndarray) -> None:
        """Hungarian Algorithm:
        ...
        ans_pos = self.hungarian_algorithm(cost_matrix.copy())  # Get the element position.
        print(f"Element position: {ans_pos}")


"""matrix = np.array([[7, 6, 2, 9, 2],
                    [6, 2, 1, 3, 9],
                    [5, 6, 8, 9, 5],
                    [6, 8, 5, 8, 6],
                    [9, 5, 6, 4, 7]])
