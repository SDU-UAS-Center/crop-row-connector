...
.. code-block:: csv
    ...
    1,0,0,1.57,0,100.5,50.2,100.5,150.3,100.5,100.25
    1,0,0,1.57,1,105.2,49.8,105.2,149.9,105.2,99.85
    2,1,0,1.57,0,205.1,51.0,205.1,151.2,205.1,101.1
...
Contains merged vegetation points from all connected rows.
